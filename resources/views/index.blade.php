...
<body class="home">
	<!-- Fixed navbar -->
	<div class="navbar navbar-light navbar-fixed-top headroom" >
		<div class="container">
	...
	<div class="container text-center">
		<br> <br>
		<h2 class="thin">l'endroit idéal pour chercher l'emploi idéal</h2>
		<p class="text-muted">
	...
	<div class="jumbotron top-space">
		<div class="container">
			...
			<h3 class="text-center thin">Pourquoi Hire me</h3>
	...
	<div class="container">
		...
		<h2 class="text-center top-space">Fréquentes questions</h2>
		<br>

		<div class="row">
			<div class="col-sm-6">
				<h3>Which code editor would you recommend?</h3>
				<p>I'd highly recommend you <a href="http://www.sublimetext.com/">Sublime Text</a> - a free to try text editor which I'm using daily. Awes
				ome tool!</p>
			</div>
			<div class="col-sm-6">
		...
		<div class="jumbotron top-space">
			<h4>Dernier témoignage.</h4>
     		<p class="text-right"><a class="btn btn-primary btn-large">Voir plus »</a></p>
  		</div>
